...
* Système hôte XCP : un utilisateur hôte XCP doit disposer d'un privilège administrateur (l'utilisateur doit faire partie du groupe "BUILTIN\Administrators" sur le système hôte XCP SMB).
